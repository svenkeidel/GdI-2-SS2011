...
public class TrieTest {
	...
	public void compress() throws FileNotFoundException, IOException {
		...
		// System.err.println("test2.png encrypted String after compress(6): \n"+x+"\n");
	...
	public void Six() throws FileNotFoundException, IOException {
		...
		BufferedImage ThreeComp = triecode.decryptImage(ThreeChopp,
				reader.getHeight(), reader.getWidth());
		...
		BufferedImage SixComp = triecode.decryptImage(SixChopp,
				reader.getHeight(), reader.getWidth());
